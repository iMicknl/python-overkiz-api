...
class TestSetup:
    ...
    def test_id_is_raw_but_repr_is_redacted_when_present(self) -> None:
    ...
    def test_id_is_none_when_missing(self) -> None:
    ...
    def test_id_is_none_without_input_id(self) -> None:
...
class TestDevice:
    ...
    def test_invalid_device_url_raises(self, device_url: str) -> None:
    ...
    def test_none_states(self) -> None:
    ...
    def test_select_first_command(self) -> None:
    ...
    def test_supports_command(self) -> None:
    ...
    def test_supports_any_command(self) -> None:
    ...
    def test_select_first_state_value(self) -> None:
    ...
    def test_has_state_value(self) -> None:
    ...
    def test_has_any_state_value(self) -> None:
    ...
    def test_get_state_definition(self) -> None:
    ...
    def test_select_first_state_definition(self) -> None:
    ...
    def test_select_first_attribute_value_returns_first_match(self) -> None:
    ...
    def test_select_first_attribute_value_returns_none_when_no_match(self) -> None:
    ...
    def test_select_first_attribute_value_empty_attributes(self) -> None:
    ...
    def test_select_first_attribute_value_with_none_values(self) -> None:
...
class TestStates:
    ...
    def test_getter_missing(self) -> None:
        """Requesting a missing state returns falsy (None)."""
        states = States(RAW_STATES)
        state = states.get("FooState")
        assert not state

    def test_select_returns_first_match(self) -> None:
    ...
    def test_select_value_returns_first_value(self) -> None:
    ...
    def test_select_value_returns_none_when_no_match(self) -> None:
    ...
    def test_getitem_raises_keyerror_on_missing(self) -> None:
        """Subscript access raises KeyError for missing states."""
        states = States(RAW_STATES)
        with pytest.raises(KeyError, match="nonexistent"):
            states["nonexistent"]

    def test_getitem_returns_state_on_hit(self) -> None:
    ...
    def test_setitem_appends_new(self) -> None:
...
class TestCommandDefinitions:
    ...
    def test_getitem_returns_command_on_hit(self) -> None:
...
class TestDefinition:
    ...
    def test_get_state_definition_returns_first_match(self) -> None:
    ...
    def test_get_state_definition_returns_none_when_no_match(self) -> None:
    ...
    def test_has_state_definition_returns_true(self) -> None:
    ...
    def test_has_state_definition_returns_false(self) -> None:
    ...
    def test_has_state_definition_empty_states(self) -> None:
...
class TestStateDefinition:
    ...
    def test_requires_name_or_qualified_name(self) -> None:
...
class TestState:
    ...
    def test_bad_float_value(self) -> None:
    ...
    def test_bad_str_value(self) -> None:
    ...
    def test_bad_dict_value(self) -> None:
    ...
    def test_bad_list_value(self) -> None:
...
def test_command_to_payload_omits_none() -> None:
...
def test_action_to_payload_and_parameters_conversion() -> None:
    ...
    assert commands[0]["name"] == "setLevel"  # type: ignore[index]
    assert commands[0]["type"] == 1  # type: ignore[index]
    # parameters should be converted to primitives (enum -> str)
    assert commands[0]["parameters"] == [10, "A"]  # type: ignore[index]
